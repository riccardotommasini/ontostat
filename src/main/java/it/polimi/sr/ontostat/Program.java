...
public class Program {
    ...
    public void run(boolean materialize, boolean persist, boolean profile, String tbox_file, String abox_file, Entailment ent) throws IOException {
        ...
        //QueryUtils.selectPrinter("SELECT  WHERE {?s ?p ?o}", infmodel);
